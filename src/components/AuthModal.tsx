...
export function AuthModal() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      else if (mode === 'signup') { await signUp(email, password, fullName); setSuccess('Account created! Check your email.'); }
    ...
    <div className="login-page">
      ...
      <div className="login-card">
        ...
        <div className="login-logo">
          ...
          <span className="login-logo-name">Escema</span>
        </div>
        ...
        {mode !== 'reset' && (showGoogle || showGitHub) && (
          <div className="login-oauth">
            {showGoogle && (
              <button type="button" className="login-oauth-btn login-oauth-btn--google"
            ...
            {showGitHub && (
              <button type="button" className="login-oauth-btn login-oauth-btn--github"
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          {error   && <div className="login-error"><span>✕</span><span>{error}</span></div>}
          {success && <div className="login-success"><span>✓</span><span>{success}</span></div>}
